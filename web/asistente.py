...
def diagnostico(t):
    ...
    data = {
        ...
        "seguridad": ("Riesgo de ciberseguridad o posible fraude digital", "Primero hay que identificar activos, amenazas, señales de fraude, vulnerabilidades y controles existentes.", ["Evaluación de riesgos", "Hacking ético y revisión de vulnerabilidades con autorización", "Prevención de fraude y phishing", "Análisis y documentación responsable de incidentes", "Capacitación y concientización"], "Priorizar riesgos por impacto, preservar evidencias cuando corresponda y verificar la reducción de exposición."),
